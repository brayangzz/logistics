...
/* ─── State → filter bucket ─── */
type FilterBucket = "Todos" | "Pendiente" | "En Proceso" | "Listo";
...
/* ─── Filter pills (same style as LogisticsLegend) ─── */
...
/* ─── Initials color map (unique to anticipated clients) ─── */
...
export const AnticipatedOrdersTable = () => {
  ...
  // Reset to page 1 when filters change — handled implicitly via safePage
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center gap-3">
        ...
        {/* Legend pills — identical to LogisticsLegend */}
        <div
