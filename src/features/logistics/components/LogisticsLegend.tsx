...
export const LogisticsLegend = ({ statusFilter, onStatusChange }: LogisticsLegendProps) => {
  return (
    <div
      className="flex items-center gap-1 p-1.5 rounded-xl border relative z-10 w-full sm:w-fit overflow-x-auto sm:overflow-visible"
      ...
      {STATUSES.map((status) => {
        ...
        return (
          <button
            ...
            className="relative flex items-center gap-2 px-3.5 py-2 rounded-lg font-semibold text-sm transition-colors duration-150 justify-center focus:outline-none shrink-0 flex-1 sm:flex-none"
